...
def results_metric_extract_start(results_directory,output_directory):
    ...
    for a in parent_dir_list:
        ...
        final_results_file_path = results_directory + '\\' + a + '\\psm_results_w_motif.csv'
    ...
    file_path = output_directory + '\\metrics_extracted_motif.csv'
